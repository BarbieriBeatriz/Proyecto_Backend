...
#obtener la fecha de nacimiento de cada ahijado y luego calcular la edad en años
    ...
    # def calcular_compatibilidad_donante(self, grupoSanguineo):
    # # Obtener todos los donantes con el mismo grupo sanguíneo
    #     donantes_compatibles = "donantes.query.filter_by(grupoSanguineo=grupoSanguineo).all()"
        
    #     # Inicializar contador de donantes compatibles
    #     donanteCompatible = 0
        
    #     # Iterar sobre los donantes compatibles
    #     for donante in donantes_compatibles:
    #         # Aquí debes implementar la lógica específica para determinar compatibilidad
    #         # Por ejemplo, podrías tener una función que evalúe la compatibilidad entre el receptor y el donante
    #         if grupoSanguineo =(donante):
    #             donanteCompatible += 1
        
    #     # Retornar el número total de donantes compatibles
    #     return donanteCompatible
...
donarEnVida = DonarEnVida(host='localhost',user='root', password='', database='donar_en_vida')
